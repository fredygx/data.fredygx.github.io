...
LOG_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "log_penelitian-groq.txt")
...
if __name__ == '__main__':
    ...
    app = ApplicationBuilder().token("BOT TELE").build()
    app.add_handler(MessageHandler(filters.TEXT & (~filters.COMMAND), handle_message))
    print("Bot Inventaris Berjalan & Logger Aktif!")
    app.run_polling()
